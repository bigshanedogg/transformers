...
class HyperCLOVAXAttention(nn.Module):
    ...
    def __init__(self, config: HyperCLOVAXConfig, layer_idx: int):
        ...
        # Maximal Update Parametrization (MuP): override default 1/sqrt(head_dim) scaling
...
class HyperCLOVAXDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: HyperCLOVAXConfig, layer_idx: int):
        ...
        # Maximal Update Parametrization (MuP): residual scaling factor
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # Peri-Layer Normalization: post-norm after attention output
        if self.use_post_norm:
            hidden_states = self.post_norm1(hidden_states)

        # Maximal Update Parametrization (MuP): scaled residual addition
        ...
        # Peri-Layer Normalization: post-norm after MLP output
        if self.use_post_norm:
...
class HyperCLOVAXModel(HyperCLOVAXPreTrainedModel):
    def __init__(self, config: HyperCLOVAXConfig):
        ...
        # Maximal Update Parametrization (MuP): embedding output scaling
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # Maximal Update Parametrization (MuP): scale embedding outputs
...
class HyperCLOVAXForCausalLM(HyperCLOVAXPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: HyperCLOVAXConfig):
        ...
        # Maximal Update Parametrization (MuP): logits scaling factor
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # Maximal Update Parametrization (MuP): scale logits before loss/sampling
